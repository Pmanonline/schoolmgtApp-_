...
const UpdateStudent = () => {
  ...
  useEffect(() => {
    if (studentDetail) {
      ...
      setStudentAge(studentDetail.studentAge);
      setStudentClass(studentDetail.studentClass.toUpperCase());
      setStudentCourse(studentDetail.studentCourse);
    }
  }, [studentDetail]);
                ...
                <div className="form-group">
                  ...
                  <div className=" block text-start mod:text-center mb-4">
                    ...
                    <Select
                      ...
                      value={studentCourse.map((course) => ({
                        value: course,
                        label: course,
                      }))}
                  ...
                  <div className="text-start mod:text-center mt-3">
                    <button className="ml-[10px] relative">
                      {isLoading ? (
                        ...
                        <button className="w-full px-6 py-2 mt-3 text-center text-white bg-indigo-900 rounded-md lg:ml-5">
                          Update Student
                        </button>
                      )}
                    </button>
